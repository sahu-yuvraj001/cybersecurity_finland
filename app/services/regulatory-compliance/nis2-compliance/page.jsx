  ...
  const penalties = [
    {
      ...
      text: "Up to €10 million or 2% of annual turnover",
      color: "bg-red-50 border-red-100 text-red-700",
    },
    {
      title: "Management Liability",
      text: "Personal sanctions for senior management",
      color: "bg-red-50 border-red-100 text-red-700",
    },
    {
      title: "Operational Sanctions",
      text: "Suspension of services",
      color: "bg-red-50 border-red-100 text-red-700",
    },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-slate-600 mb-6 max-w-2xl">
              Expert NIS2 compliance guidance for essential and important
              entities. Professional services to help organizations meet EU
              cybersecurity requirements through comprehensive risk management,
              technical controls, and regulatory reporting.
            </p>

            <div className="flex flex-wrap gap-3">
              <Link
                href="/contact"
                className="inline-flex items-center px-5 py-3 bg-slate-900 text-white rounded-md shadow hover:bg-slate-800 transition"
              >
              ...
              <Link
                ...
                className="inline-flex items-center px-5 py-3 border border-slate-200 text-slate-800 rounded-md hover:bg-slate-50 transition"
              >
                View NIS2 Framework
              </Link>
            </div>
      ...
      <section className="bg-slate-50 py-12">
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          ...
          <p className="text-center text-slate-600 max-w-3xl mx-auto mb-8">
            ...
            organization achieves and maintains compliance while building
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-6">
            {serviceAreas.map((s) => (
              <article
                key={s.title}
                className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm hover:shadow-md transition transform hover:-translate-y-1"
              >
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-10">
          ...
          <div className="space-y-4">
            {timeline.map((t) => (
              <div
                key={t.step}
                className="flex items-start gap-4 bg-white border border-slate-100 rounded-lg p-4 shadow-sm"
              >
                <div className="flex-shrink-0">
                  <div
                    className={`w-10 h-10 rounded-full flex items-center justify-center text-white ${t.color}`}
                  >
                    {t.step}
                  </div>
                </div>
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {penalties.map((p) => (
              <div
                key={p.title}
                className={`p-6 rounded-lg border ${p.color} shadow-sm transition-all duration-300 hover:bg-slate-50 hover:shadow-md hover:-translate-y-1`}
              >
      ...
      <section className="py-12">
        <div className="max-w-4xl mx-auto px-6 lg:px-10 text-center">
          ...
          <p className="text-slate-600 mb-6">
            Don't wait until the deadline. Start your NIS2 compliance journey
            today with expert Finnish regulatory guidance and proven
            implementation methodologies.
          </p>
          <Link
            href="/contact"
            className="inline-flex items-center px-6 py-3 bg-slate-900 text-white rounded-md shadow hover:bg-slate-800 transition"
          >
            Start NIS2 Assessment
          </Link>
        </div>
